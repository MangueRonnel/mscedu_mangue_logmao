@extends('layouts.app')
@section('title', 'Assessment Form Builder')
...
<form action="/classrooms/{{$classroom->code}}/assessments/builder/preview" method="POST" id="previewForm" target="_blank">
    @csrf
...
<form action="/classrooms/{{$classroom->code}}/assessments/builder/process" method="POST" id="formData">
    @csrf
...
{{-- Modals --}}
<x-modals.confirm trigger="save" action="saveFormData()"/>
