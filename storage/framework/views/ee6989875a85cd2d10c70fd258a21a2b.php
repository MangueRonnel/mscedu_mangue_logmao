    ...
    <div class="fixed inset-0 p-4 flex flex-wrap justify-center items-center w-full h-full z-[1000] before:fixed before:inset-0 before:w-full before:h-full before:bg-[rgba(0,0,0,0.5)] overflow-auto font-[sans-serif]">
        <div class="w-full max-w-lg bg-white shadow-lg rounded-lg p-6 relative">
            ...
            <div class="my-6 text-center">
                <h4 class="text-3xl text-[#333] font-extrabold">Sign Up</h4>
                <p class="text-sm text-gray-400 mt-4">Create account with us</p>
            </div>
            <form action="/register/process" method="POST" class="space-y-4">
                ...
                <div class="flex">
                    <input type="checkbox" class="w-4" name="terms" required/>
                    <label class="text-sm ml-4 text-[#333]">I have read and accept the <a href="javascript:void(0)"
                    class="text-sm text-blue-600 font-semibold">Terms and Conditions</a></label>
                </div>
                <button type="submit"
                    class="px-6 py-3 !mt-12 w-full font-semibold bg-blue-600 hover:bg-blue-700 text-white rounded-full">Create
                    Account
                </button>
            </form>
            <hr class="my-6" />
            <p class="text-sm text-center text-[#333]">Already have an account?
            <a href="/login" class="text-sm text-blue-600 font-semibold">Sign in</a>
            </p>
        </div>
    </div>
</body>
</html><?php /**PATH C:\laragon\www\quizwatch\resources\views/register.blade.php ENDPATH**/ ?>