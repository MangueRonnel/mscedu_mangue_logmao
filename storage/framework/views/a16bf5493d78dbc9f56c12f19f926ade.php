...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.cards.dashboard','data' => ['iconBackgroundColor' => 'bg-blue-400','title' => 'Owned Class','value' => ''.e(count(auth()->user()->getOwnedClassrooms())).'','defaultIcon' => 'false']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['iconBackgroundColor' => 'bg-blue-400','title' => 'Owned Class','value' => ''.e(count(auth()->user()->getOwnedClassrooms())).'','defaultIcon' => 'false']); ?>
...
<?php endif; ?>
    <?php if (isset($component)) { $__componentOriginal48427adc95e78cdfcd2a07ebbfb0b518 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal48427adc95e78cdfcd2a07ebbfb0b518 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.cards.dashboard','data' => ['iconBackgroundColor' => 'bg-orange-400','title' => 'Joined Class','value' => ''.e(count(auth()->user()->getJoinedClassrooms())).'','defaultIcon' => 'false']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('cards.dashboard'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['iconBackgroundColor' => 'bg-orange-400','title' => 'Joined Class','value' => ''.e(count(auth()->user()->getJoinedClassrooms())).'','defaultIcon' => 'false']); ?>
...
<?php endif; ?>
    <?php if (isset($component)) { $__componentOriginal48427adc95e78cdfcd2a07ebbfb0b518 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal48427adc95e78cdfcd2a07ebbfb0b518 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.cards.dashboard','data' => ['iconBackgroundColor' => 'bg-red-400','title' => 'Assessment Answered','value' => ''.e(count(auth()->user()->answers)).'','defaultIcon' => 'false']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('cards.dashboard'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['iconBackgroundColor' => 'bg-red-400','title' => 'Assessment Answered','value' => ''.e(count(auth()->user()->answers)).'','defaultIcon' => 'false']); ?>
...
<div class="grid grid-cols-1 gap-4 lg:grid-cols-3 w-full justify-center items-start">
    <?php if(auth()->user()->getLatestAssessment() != null): ?>
        <div class="grid bg-white shadow-[0_2px_15px_-6px_rgba(0,0,0,0.2)] px-6 py-8 w-full rounded-lg font-[sans-serif] overflow-hidden">
            ...
            <div class="mt-8 space-y-4 min-h-72">
                <?php $__currentLoopData = auth()->user()->getLatestAssessment()->answers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $answer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.cards.user','data' => ['profile' => ''.e($answer->user->profile).'','name' => ''.e($answer->user->name).'','email' => ''.e($answer->user->email).'','value' => ''.e($answer->score).' / '.e(auth()->user()->getLatestAssessment()->total).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['profile' => ''.e($answer->user->profile).'','name' => ''.e($answer->user->name).'','email' => ''.e($answer->user->email).'','value' => ''.e($answer->score).' / '.e(auth()->user()->getLatestAssessment()->total).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <div class="grid lg:col-span-2 bg-white shadow-[0_2px_15px_-6px_rgba(0,0,0,0.2)] px-6 py-8 w-full rounded-lg font-[sans-serif] items-center justify-center">
            <input type="text" class="hidden" id="sectionAverage" value="<?php echo e(json_encode(auth()->user()->getLatestAssessment()->getSectionAverage())); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\quizwatch\resources\views/dashboard.blade.php ENDPATH**/ ?>